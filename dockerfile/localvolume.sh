...
/usr/local/jdk1.8.0_191/bin/java ${JAVA_OPT} com.alibaba.graphscopetest.k8s.CopyFromHdfsMain $inner_config  1>./logs/maxgraph-coordinator.out 2>./logs/maxgraph-coordinator.err